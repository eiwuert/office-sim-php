(function($){
	...
	{
		$.getJSON("/demos/demo11/simulate", function(data)
		{
	...
	function graphMarketingHitMiss(data)
	{
	    ...
	    referalHitMiss = new Chart($('#referalHitMiss'), {
		    type: 'pie',
		    data: {
			    labels: data.Marketing.hitmiss.Referall.labels,
			    datasets: data.Marketing.hitmiss.Referall.datasets
			}
		});
		...
		advertisingHitMiss = new Chart($('#advertisingHitMiss'), {
		    type: 'pie',
		    data: {
			    labels: data.Marketing.hitmiss.Advertisment.labels,
			    datasets: data.Marketing.hitmiss.Advertisment.datasets
			}
		});
